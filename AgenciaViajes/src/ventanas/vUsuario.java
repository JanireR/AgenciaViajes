...
public class vUsuario extends JFrame implements ActionListener{
	...
	public vUsuario() {
		...
		btnReservar.setIcon(new ImageIcon(vUsuario.class.getResource("/imagenes/boton_reserva_150.png")));
		...
		btnSalir.setIcon(new ImageIcon(vUsuario.class.getResource("/imagenes/salir.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (botonPulsado==btnReservar) {
			try{
				...
				//Usuario nueva=new Usuario(nombre.getText(),apellido.getText(),dni.getText(),Integer.parseInt(telefono.getText()));
				//v.add(nueva);
